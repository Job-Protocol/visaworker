...
- Use, modify, and redistribute the source code under the terms of the
  [LICENSE](./LICENSE).
- Refer to VisaWorker by name in factual, descriptive contexts (e.g. "based
  on VisaWorker", "originally forked from VisaWorker").
...
If you distribute a fork, please pick your own name and remove the
`public/brand/` assets and any VisaWorker wordmark from your build.

Questions: open an issue or email legal@visaworker.ai.
